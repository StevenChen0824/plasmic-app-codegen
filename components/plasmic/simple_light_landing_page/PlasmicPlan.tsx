...
import BaseCard from "../../BaseCard"; // plasmic-import: dX6kOEasSO42/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: W3vYx6YbX8OR/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__yLOl)}>
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__cny5E)}
        >
          {renderPlasmicSlot({
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__gsDp6)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__fms2B)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__i5OJl)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___7IeB5)}
                />
              </Stack__>
            ),
            value: args.description
          })}
          <div className={classNames(projectcss.all, sty.freeBox__yYlrd)}>
            {renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__buyW)}
                  color={"outlineBlue"}
                  submitsForm={true}
                >
                  {"Get started"}
