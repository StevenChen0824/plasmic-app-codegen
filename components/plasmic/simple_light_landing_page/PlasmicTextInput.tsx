...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: WFOCHderyoi9/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__qZiWi)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__w6CEx)}
              role={"img"}
            />
          ),
