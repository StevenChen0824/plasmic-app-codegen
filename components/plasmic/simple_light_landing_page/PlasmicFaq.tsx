...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: -USByCqZkboR/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rjQb)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__uh7Ci)}>
          <div className={classNames(projectcss.all, sty.freeBox__sd0BH)}>
            {renderPlasmicSlot({
