...
import Plan from "../../Plan"; // plasmic-import: W3vYx6YbX8OR/component
...
import Faq from "../../Faq"; // plasmic-import: -USByCqZkboR/component
...
import sty from "./PlasmicPricing.module.css"; // plasmic-import: _rfX1MT3HI3A/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column__zOpRh)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan___8Lcw8)}
                  price={
                    <div
                      className={classNames(
                        projectcss.all,
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__r6BGn)}
                    color={"outlineBlue"}
                    submitsForm={true}
                  >
                    {"Get started"}
              ...
              <div className={classNames(projectcss.all, sty.column__rquns)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__qldFm)}
                  description={
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__vMwol)}
                    >
                      <Bullet
                        className={classNames(
                          "__wab_instance",
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__s8QyO)}
                    color={"blue"}
                    submitsForm={true}
                  >
                    {"Get started"}
              ...
              <div className={classNames(projectcss.all, sty.column__oszN7)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan___4Pmhi)}
                  name={"Enterprise"}
                  price={
                    <div
                      className={classNames(
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__efWEh)}
                    color={"outlineBlue"}
                    submitsForm={true}
                  >
                    {"Get started"}
          ...
          >
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___024Bs)}
            >
              <Faq
                className={classNames("__wab_instance", sty.faq__f6Xdo)}
                slot={
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__jr8T6)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__f8Xw5)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
