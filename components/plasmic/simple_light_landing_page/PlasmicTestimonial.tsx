...
import Avatar from "../../Avatar"; // plasmic-import: PdwPoHh68W0D/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: Bf0efIZKwhmX/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: wieUrjhbZubv/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__tKIv)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___4ORwj)}
        >
          <div
            className={classNames(
              projectcss.all,
